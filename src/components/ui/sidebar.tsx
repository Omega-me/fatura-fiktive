...
interface ButtonProps extends React.ComponentProps<typeof Button> {
  sidebarLabel?: string; // Add the sidebarLabel prop here
}
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof Button>, ButtonProps>(({ sidebarLabel, className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      {sidebarLabel && open && <span>{sidebarLabel}</span>}
